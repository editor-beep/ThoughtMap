  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        {hasAttachments && (
          <Paperclip size={9} className="text-slate-600 flex-shrink-0" aria-label="Has attachments" />
        )}
        {commentCount > 0 && (
        ...
        {hasChildMap && (
          <GitBranch size={10} className="text-cosmic-cyan/80 flex-shrink-0" aria-label="Has sub-map" />
        )}
